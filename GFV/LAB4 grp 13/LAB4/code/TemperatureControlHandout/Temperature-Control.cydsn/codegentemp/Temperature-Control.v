...
module I2C_v3_50_1 (
	...
	cy_clock_v1_0
		#(.id("7b41d9b8-3862-4d88-81a1-94cae1d17bf3/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ce934fd8-0533-421e-bc32-b67628731c11"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("ed7b6f78-e61f-481c-ad40-8386897b602a"),
		  .source_clock_id(""),
		  .divisor(0),
