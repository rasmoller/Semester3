...
*/
     ...
     *  @{
     */
        #define Pin_PWM_INTR_NONE      (uint16)(0x0000u)
        #define Pin_PWM_INTR_RISING    (uint16)(0x0001u)
        #define Pin_PWM_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_PWM_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_PWM_INTR_MASK      (0x01u) 
#endif /* (Pin_PWM__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_PWM__SIO_CFG)
    #define Pin_PWM_SIO_HYST_EN        (* (reg8 *) Pin_PWM__SIO_HYST_EN)
    #define Pin_PWM_SIO_REG_HIFREQ     (* (reg8 *) Pin_PWM__SIO_REG_HIFREQ)
    #define Pin_PWM_SIO_CFG            (* (reg8 *) Pin_PWM__SIO_CFG)
    #define Pin_PWM_SIO_DIFF           (* (reg8 *) Pin_PWM__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Pin_PWM_0_INTTYPE_REG 		(* (reg8 *) Pin_PWM__0__INTTYPE)
#endif /* (Pin_PWM__INTSTAT) */
