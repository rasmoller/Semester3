...
module top ;
	...
	wire [0:0] tmpOE__stepCtrl1_net;
	wire [0:0] tmpFB_0__stepCtrl1_net;
	wire [0:0] tmpIO_0__stepCtrl1_net;
	wire [0:0] tmpINTERRUPT_0__stepCtrl1_net;
	electrical [0:0] tmpSIOVREF__stepCtrl1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		stepCtrl1
		 (.oe(tmpOE__stepCtrl1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__stepCtrl1_net[0:0]}),
		  .io({tmpIO_0__stepCtrl1_net[0:0]}),
		  .siovref(tmpSIOVREF__stepCtrl1_net),
		  .interrupt({tmpINTERRUPT_0__stepCtrl1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepCtrl1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__stepCtrl4_net;
	wire [0:0] tmpFB_0__stepCtrl4_net;
	wire [0:0] tmpIO_0__stepCtrl4_net;
	wire [0:0] tmpINTERRUPT_0__stepCtrl4_net;
	electrical [0:0] tmpSIOVREF__stepCtrl4_net;

	cy_psoc3_pins_v1_10
		#(.id("e00cfc18-56d2-4203-a7b1-cd24fd1e2bb5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		stepCtrl4
		 (.oe(tmpOE__stepCtrl4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__stepCtrl4_net[0:0]}),
		  .io({tmpIO_0__stepCtrl4_net[0:0]}),
		  .siovref(tmpSIOVREF__stepCtrl4_net),
		  .interrupt({tmpINTERRUPT_0__stepCtrl4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepCtrl4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__stepCtrl3_net;
	wire [0:0] tmpFB_0__stepCtrl3_net;
	wire [0:0] tmpIO_0__stepCtrl3_net;
	wire [0:0] tmpINTERRUPT_0__stepCtrl3_net;
	electrical [0:0] tmpSIOVREF__stepCtrl3_net;

	cy_psoc3_pins_v1_10
		#(.id("dfbda4cf-d3f6-470f-b41c-d3e9ff5bd8a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		stepCtrl3
		 (.oe(tmpOE__stepCtrl3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__stepCtrl3_net[0:0]}),
		  .io({tmpIO_0__stepCtrl3_net[0:0]}),
		  .siovref(tmpSIOVREF__stepCtrl3_net),
		  .interrupt({tmpINTERRUPT_0__stepCtrl3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepCtrl3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__stepCtrl2_net;
	wire [0:0] tmpFB_0__stepCtrl2_net;
	wire [0:0] tmpIO_0__stepCtrl2_net;
	wire [0:0] tmpINTERRUPT_0__stepCtrl2_net;
	electrical [0:0] tmpSIOVREF__stepCtrl2_net;

	cy_psoc3_pins_v1_10
		#(.id("26d8cdb2-ade0-4351-8df7-fce839dd685a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		stepCtrl2
		 (.oe(tmpOE__stepCtrl2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__stepCtrl2_net[0:0]}),
		  .io({tmpIO_0__stepCtrl2_net[0:0]}),
		  .siovref(tmpSIOVREF__stepCtrl2_net),
		  .interrupt({tmpINTERRUPT_0__stepCtrl2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepCtrl2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
